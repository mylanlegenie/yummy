    ...
    <nav className="flex w-full mx-auto mt-20 justify-around items-center ">
      ...
      <div className="flex items-center justify-center gap-4">
        <a
          ...
          target="_blank"
        >
          <button className="w-25 -translate-y-px cursor-pointer rounded-full border border-white/80 bg-[#23140F] px-5 shadow-[0_4px_0_#100A08] transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_5px_0_#100A08] active:translate-y-0.5 active:shadow-[0_1px_0_#100A08]">
            <WordRotate
